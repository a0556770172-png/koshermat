    ...
    <div class="card" style="margin-bottom:10px;">
      <div class="flex" style="justify-content:space-between; align-items:start;">
        <div>
          ...
          <div class="muted" style="font-size:12px; margin-top:4px;">${timeAgo(r.created_at)}${r.game_id ? ` · <a href="game.html?id=${r.game_id}">צפייה במשחק</a>` : ""}</div>
        </div>
  ...
  box.innerHTML = data
    ...
    <div class="game-list-item">
      ...
      <div class="flex gap-1">
        <a href="game.html?id=${g.id}" class="btn btn-ghost" style="padding:6px 12px; font-size:12px;">צפייה</a>
